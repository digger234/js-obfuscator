...
4. **Hạn chế newlines** - CẤM dùng parameter/pattern/v index/elif phân chia
5. **CẤM đặt tên hàm và biến quá dài** - Cấm có dấu gạch "\_" ở giữa tên biến hay hàm, Cấm có prefix trong tên, Chỉ được đặt từ đơn, Cấm đặt 2 từ có nghĩa ghép dính liền lại để lách luật, Cấm có chữ "visit" trong tên, Cấm viết hoa lung tung ( chỉ được phép đặt tên hoa nếu python yêu cầu bắt buộc ). Cấm đánh số thứ tự khi đặt tên
...
10. **CẤM tạo file test** - Cấm tạo bất kì file test nào ngoài test.js do tao tạo
...
12. **LUÔN chạy test** - Sau khi kết thúc edit hoặc bất kì chỉnh sửa nào liên quan đến obf.js đều phải obfuscate lại file test.js và chạy test_obf.js
...
14. **CẤM tạo list nhỏ lẻ giữa/cuối file** - Muốn thêm list/constant thì thêm VÀO ĐẦU FILE, cấm tạo list ở giữa hoặc cuối file
